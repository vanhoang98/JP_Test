                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%;">Dạng bài thi</th>
                                <th style="text-align: center; width: 10%;">Vòng thi</th>
                                <th style="width: 15%;">Giáo viên ra đề</th>
                                <th style="text-align: center; width: 18%;">Tiến độ</th>
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td style="vertical-align: inherit;">{{ $item->teacher->name }}</td>
                                ...
                                <td style="vertical-align: inherit; text-align: center;">
                                    ...
                                    <a href="{{ route("test.get_edit", $item->id) }}" class="btn btn-xs btn-primary">
                                        <i class="fa fa-edit"></i> Sửa
                                    </a>
                                    <a data-toggle="modal" data-target="#delete_{{$item->id}}" href=""  class="btn btn-xs  btn-danger"> 
                                        <i class="fa fa-trash"></i> Xóa
                                    </a>
                                    @include('backend.tests.delete')
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
