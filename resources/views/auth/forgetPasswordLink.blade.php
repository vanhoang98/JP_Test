                                ...
                                <ul class="login-input">
                                    ...
                                    <li>
                                        <div class="ioe-input">
                                            ...
                                            <input type="password" id="password" name="password_confirmation" placeholder="Nhập lại mật khẩu" required>
                                        </div>
                                    </li>
                                    @if($errors->any())
                                        <li>
                                    ...
                                    @endif
                                    <li>
                                        <button type="submit" class="btn-gra-blue-36" id="btnlogin" style="border: none; outline: none">Đặt lại mật khẩu
                                        </button>
                                    </li>
                                </ul>
                            </div>
