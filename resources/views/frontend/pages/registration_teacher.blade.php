                ...
                <div class="login-content">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <div class="login-info" style="margin-top: 15px;">
                                <div class="login-txt" style="margin-bottom: 0;">
                                    <span style="font-size: 25px; color: #545454"><b>Đăng ký tài khoản giáo viên</b></span>
                                </div>
                                <font color="red"><label id="error-message"> @include("messages")
                                </label></font>
                            </div>

                            <form action="{{ route('post_registration_teacher') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <ul class="login-input">
                                    ...
                                    <li>
                                        <div class="ioe-input">
                                            ...
                                            <input  required type="text" id="name" name="phone" value="{{ old('phone') }}" placeholder="Số điện thoại">
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="">
                                            <label style="color:#898989">CV</label><br>
                                            <input required type="file" id="CV" name="cv" accept="application/pdf">
                                        </div>
                                    </li>
                                    <li>
                                        <a href="">
                                    ...
                                    <li>
                                        <a href="{{ route('teacher.login') }}" class="btn-txt-black-36">Đăng nhập</a>
                                    </li>
                                </ul>
                            </form>
                        </div>
