<div class="modal fade" id="addCategoryPost" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="card-title">{{ trans('home.add_categories_post') }}</h3>
                <button type="button" class="close white" data-dismiss="modal">&times;</button>
            </div>

            <form method="POST" action="{{ route('admin.storePost') }}">
                @csrf
                <div class="card-body">
