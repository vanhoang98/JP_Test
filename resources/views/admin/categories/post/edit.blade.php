<div class="modal fade" id="editCategoryPost" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="card-title">{{ trans('home.edit_categories_post') }}</h3>
                <button type="button" class="close white" data-dismiss="modal">&times;</button>
            </div>

            <form method="POST" action="{{ route('admin.updatePost', 'category') }}">
                @csrf
                @method('PATCH')
                <div class="modal-body">
                    ...
                    <div class="card-body"> 
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control name" name="name_post" required
