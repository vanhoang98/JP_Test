...
var KTamChartsChartsDemo = function() {
    ...
    var demo2 = function() {
        var chart = AmCharts.makeChart("kt_amcharts_2", {
            ...
            "graphs": [{
                "alphaField": "alpha",
                "balloonText": "<span style='font-size:12px;'>[[title]] in [[cates]]:<br><span style='font-size:20px;'>[[value]]</span> [[additional]]</span>",
                "fillAlphas": 1,
                "title": "Income",
                "type": "column",
                "valueField": "income",
    ...
    var demo3 = function() {
        var chart = AmCharts.makeChart("kt_amcharts_3", {
            ...
            "startDuration": 1,
            "graphs": [{
                "balloonText": "GDP grow in [[cates]] (2004): <b>[[value]]</b>",
                "fillAlphas": 0.9,
                "lineAlpha": 0.2,
                "title": "2004",
                "type": "column",
                ...
                "balloonText": "GDP grow in [[cates]] (2005): <b>[[value]]</b>",
                "fillAlphas": 0.9,
                "lineAlpha": 0.2,
                "title": "2005",
                "type": "column",
    ...
    var demo5 = function() {
        var chart = AmCharts.makeChart("kt_amcharts_5", {
            ...
            "startDuration": 1,
            "graphs": [{
                "balloonText": "<span style='font-size:13px;'>[[title]] in [[cates]]:<b>[[value]]</b></span>",
                "title": "Income",
                "type": "column",
                "fillAlphas": 0.8,
